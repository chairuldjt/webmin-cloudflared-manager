...
print &ui_table_start("Log Viewer Options", "width=80%");

print &ui_table_row("Service",
    &ui_select("service", $service, \@service_options));

print &ui_table_row("Lines",
    &ui_textbox("lines", $lines, 6) . " " . &ui_submit("View"));

print &ui_table_row("Filter (grep)",
    &ui_textbox("filter", $filter, 30) . " " . &ui_submit("Filter"));
